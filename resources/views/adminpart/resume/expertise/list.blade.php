                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                           ...
                           <td> 
                            <a href="{{route('expertiseedit',$item->id)}}"><i class="fa-solid fa-pencil"></i></a><b class="p-2">||</b>

                            <a href="{{route('expertiseshow',$item->id)}}"><i class="fa-solid fa-eye"></i></a><b class="p-2">||</b>

                            <form class="d-inline border-0" action="{{route('expertisedelete',$item->id)}}" method="POST">
                              @csrf
                              @method('DELETE')
